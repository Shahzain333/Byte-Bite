...
console.log(conf.appWriteDishesCollectionId);
console.log(conf.appWriteDishesBucketId);
  ...
  return (
    ...
    <section className="space-y-15">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center justify-center mt-10 gap-5 mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-5 md:w-2xl justify-between">
          ...
          <div className="flex flex-col gap-1">
            ...
            <select
              ...
              name="category"
              id="category"
              className="sm:w-lg md:w-52 text-secondary py-2 px-4 rounded border focus:border-2 
              focus:border-secondary transition duration-300 ease-in-out">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            ...
            <textarea
              ...
              name="description"
              id="description"
              className="w-[12.4rem] sm:w-lg md:w-2xl outline-none rounded border focus:border-2 
        ...
        <Button type="submit" className="bg-primary font-medium text-sm w-52 sm:w-lg md:w-2xl py-3 px-4 rounded 
        text-gray-50 hover:bg-secondary cursor-pointer transition duration-300 ease-in-out">
          Add Dish
        </Button>
