    ...
    <section className="pt-25 pb-10 flex flex-col items-center">
      ...
      <div className="bg-[#ebf1f4] p-8 lg:pl-10 pb-10 rounded-3xl shadow-md flex flex-row md:gap-12 lg:gap-8 justify-between">
          ...
          <div className="flex flex-col gap-2 items-center">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
              ...
              <Input
                ...
                label="Email"
                type="text"
                className={`min-w-64 md:min-w-72 ${redBorderONError(
                  errors.email
                )}`}
              ...
              <div className="min-w-64 md:min-w-72 flex flex-row items-center">
                ...
                <Input
                  ...
                  className={`min-w-64 md:min-w-72 pr-14 ${redBorderONError(
                    errors.password
                  )}`}
              ...
              <div>
                <Button type="submit" className="min-w-64 md:min-w-72 bg-primary cursor-pointer font-medium 
                text-white py-2 rounded hover:bg-amber-600 transition duration-300 ease-in-out">
                  Login
                </Button>
              </div>
            ...
            <p className="text-center text-sm">
              ...
              <Link to="/signup">
                <span className="font-medium ml-1 hover:text-secondary">
                  Signup
                </span>
              </Link>
            </p>
        ...
        <div className="hidden md:block max-w-[55%]">        
          <img loading="lazy" className="w-[36rem] h-[26rem] object-cover rounded-2xl" src={sigupImage} alt="Signup illustration"/>
        </div>
